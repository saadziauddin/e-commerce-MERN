    ...
    <Link to="/shop">
      <div className="w-full h-80 mb-20  md:bg-transparent relative font-titleFont">
        ...
        <div className="w-full md:w-2/3 xl:w-1/2 h-80 absolute px-4 md:px-0 top-0 right-0 flex flex-col items-start gap-6 justify-center">
          ...
          <button className="border-2 border-gray-900 text-gray-900 xs:text-sm sm:text-sm md:text-sm rrounded-sm bg-transparent hover:bg-[#7b246d] hover:border-[#7b246d] hover:text-white transition-colors duration-300 w-[185px] h-[50px]">
            Shop Now
          </button>
        </div>
      </div>
