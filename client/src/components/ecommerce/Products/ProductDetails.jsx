        ...
        <div className="max-w-container px-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
                ...
                <div className="flex flex-col">
                    ...
                    {/* Color & Size selector */}
                    <div className="my-4">
                        {/* Only show Color Selection if colors are available and not null in the database */}
                        {Array.isArray(productInfo?.color) && productInfo.color.length > 0 && (
                    ...
                    ${selectedColor === color ? 'bg-[#7b246d] text-white border-[#7b246d] border-2' : 'bg-gray-100 text-gray-800 border-2 border-gray-200'}`}
                        ...
                        {/* Only show Size Selection if sizes are available and not null in the database */}
                        {Array.isArray(productInfo?.size) && productInfo.size.length > 0 && (
                            <div className="flex flex-col gap-2 mb-4">
                    ...
                    <div className="flex flex-col lg:flex-row gap-4 mb-4">
                        <button
                            className="w-full lg:w-64 bg-[#7b246d] text-white hover:bg-gray-500 py-2 px-4 md:py-2 md:px-6 rounded-lg font-semibold transition-all uppercase"
                            onClick={() => {
                                handleAddCart();
                                handleNavigate();
                            }}
                        ...
                        <button
                            className="w-full lg:w-64 bg-gray-200 hover:bg-gray-300 text-[#7b246d] py-2 px-4 md:py-2 md:px-6 rounded-lg font-semibold transition-all uppercase"
                    ...
                    {productInfo?.longDescription && productInfo.longDescription.trim() !== "" && (
                        <div className="mb-10 mt-4">
                            <h2 className="text-lg font-bold text-gray-900 mb-4">Description</h2>
                            <p className="text-gray-700">{productInfo.longDescription}</p>
                        </div>
                    )}
                </div>
            </div>
