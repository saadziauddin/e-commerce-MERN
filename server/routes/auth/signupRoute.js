...
//                     imagePath: `/uploads/user_images/${req.file.filename}`
//                 }]
//                 : [{
//                     imageName: "No Image",
//                     imagePath: "No Path of Image"
//                 }];
...
router.post('/api/signup', (req, res) => {
    upload.single('profileImage')(req, res, async (uploadError) => {
        ...
        const userData = { ...req.body };
        const fullName = sanitizeField(userData.firstName) + " " + sanitizeField(userData.lastName);
        const userName = sanitizeField(userData.email);
        const postalCode = sanitizeField(userData.postalCode);
        const userRole = sanitizeField(userData.userRole);
